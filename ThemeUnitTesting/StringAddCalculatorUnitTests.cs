...
{
    [TestClass]
    public class StringAddCalculatorUnitTests
    {
        private static StringAddCalculatorUnit Instance;

        [ClassInitialize]
        public static void Inititialize(TestContext tc)
        {
            Instance = new StringAddCalculatorUnit();
        }
        ...
        public void Empty_Number_Near_Separator()
        {
